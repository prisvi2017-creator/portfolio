...
$id = $_GET["id"];
$_SESSION['id'] = $id;
$sql4 = "SELECT * FROM t_message WHERE id='$id'";
foreach($con->query($sql4)as $result4){
}

?>
  <form  action="envoyerreponse1.php" method="post" >
  <input  style="margin-top: 30px;" type="email" value=" <?php echo $result4[3];?>" name="mail"  class="box">
 <textarea style="margin-top: 30px;" name="reponse"  id="" cols="30" rows="10"></textarea>
 <input style="margin-top: 50px;" type="submit"  value="repondre" class="btn">
 <a href="message1.php"><button class="btn-rt">Retour</a></button>
  </form>
