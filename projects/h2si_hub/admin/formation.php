...
<tr>
        ...
        <td class='btn-sup'><a href='supprimform.php?supprime=<?= $formation_id; ?>' onclick="return confirm('supprimer?');">supprimer</a></td>
...
?>
   ...
   "><?php echo $fetch_enseignant['nom_prof']. ' ' . $fetch_enseignant['prenom_prof']; ?></p></td>
       ...
       <td class='btn-sup'><a href="sup.php?id_playlist=<?= $id_playlist; ?>" onclick="return confirm('supprimer?');" class="btn">Supprimer</a></td>
