...
<div class="menu">
   ...
   <div class="search">
   <form action="recherche_et.php" method="post">
     <label>
   ...
   <a href="archive.php"><button class="btn-ac">Archive etudiant</a></button>
...
<br><br>
   ...
   background-color: #fff;">
        ...
        <td class='btn-sup'><a href='supprimeretudiant.php?id=<?=$id_etudiant; ?>' onclick="return confirm('supprimer?');">Supprimer</a></td>
        <td class='btn-mod'><a href='modifieretudiant.php?id=<?=$id_etudiant; ?>'> Modifier</a></td>
...
<?php 
 ...
 ?>
    ...
    <a href="imprimer.php"><button class="btn-ac">Imprimer la liste</a></button>
