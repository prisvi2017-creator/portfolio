...
<div class="menu">
  ...
  $categorie = $_POST['categorie'];
    ...
    if(!empty($nom_pdt)){
     ...
     if (!empty($categorie)) {
   $update_categorie = $con->prepare("UPDATE t_produit SET categorie = :categorie WHERE id = :id");
   $update_categorie->bindParam(":categorie", $categorie);
   $update_categorie->bindParam(":id", $id);
   $update_categorie->execute();
   $success_msg[] = 'Catégorie modifiée avec succès!';
}
...
<table  border='0' width='98%'>
     ...
     <tr>
        ...
        <td class='btn-sup'><a href="supprimerproduit.php?supprime=<?= $produit_id; ?>">Supprimer</a></td>
