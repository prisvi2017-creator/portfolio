...
// Envoyez le message
$envoi = mail($mail,"Réponse à votre message", $reponse, $headers);

if ($envoi) {
    $success_msg[] = 'Réponse envoyée!';
} else {
    $warning_msg[] = 'Échec!';
}
    ...
    $sql6 ="UPDATE t_message SET reponse='$reponse' WHERE id='$id'" ;

$saisie = $con->exec($sql6);

if ($saisie) 

$success_msg[] = 'reponse enregistrée!'; 

  else
     
  $warning_msg[] = 'reponse non enregistrée !'; 
...
<br><br>
   <table  border='0' width='98%'>
     ...
     <tr>
        ...
        <td class='btn-sup'><a href='supprimermessage1.php?id=<?=$message_id; ?>'>Supprimer</a></td> 
 </tr>
<?php 
 }
}
