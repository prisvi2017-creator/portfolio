...
if(isset($_GET['supprime'])){
    $id = $_GET['supprime'];
    include("connexion.php");
$sup="DELETE FROM t_admin WHERE id='$id'";
$rep=$con->exec($sup);
if($rep)
    echo"<center><p class='con'>Effectué</p></center>";
else
    echo"<center><p class='sup'>Echec</p></center>";
};
?>
...
<tr>
   ...
   padding: 3px;
   background-color: rgb(14, 245, 72);">
            <img src="id/<?= $fetch['image']; ?>"height="80" style="border-radius:50%" alt="">
        </td>
        <td class='btn-sup'><a href="supprimeradmin.php?supprime=<?= $admin_id; ?>">Supprimer</a></td>
 </tr>;
