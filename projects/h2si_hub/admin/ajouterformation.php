...
<div class="menu">
   ...
   <div class="form-container">
    ...
    <form  action="" method="post">
        ...
        <option value=""selected disabled>Choisir le type de formation</option>
        <option value="formation profesionelles continues">formation profesionelles continues</option>
         <option value="formation initiales diplomantes">formation initiales diplomantes</option>
         </select>
    <input  style="margin-top: 30px;" type="text" name="nom_form" placeholder="Entrez le nom de la formation" class="box" required>
   <input style="margin-top: 50px;" type="submit" name="submit"  value="Ajouter" class="btn">
...
if(isset($_POST['submit'])){
	...
	include("connexion.php");
	$sql = "INSERT INTO t_formation(nom_form,type_form) VALUES (:nom_form, :type_form)";
    $stmt = $con->prepare($sql);
    $stmt->bindParam(":nom_form", $nom_form);
    $stmt->bindParam(":type_form", $type_form);
    $stmt->execute();
     $success_msg[] = 'formation ajouté avec succès!';
}
