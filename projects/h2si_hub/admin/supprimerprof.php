...
<div class="menu">
  ...
  <a href="ajouterprof.php"><button class="btn-aj">Inscription enseignant</a></button>
...
if(isset($_GET['supprime'])){
    $id = $_GET['supprime'];
    include("connexion.php");
$sup="DELETE FROM t_enseignant WHERE id='$id'";
$rep=$con->exec($sup);
if($rep)
$success_msg[] = 'Enseignant supprimé avec succès!';
else
$warning_msg[] = 'echec!' ;
};
?>
