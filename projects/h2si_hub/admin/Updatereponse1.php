...
<div class="menu">
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $nouvelleReponse = $_POST["reponse"];

    // Mettre à jour la base de données avec la nouvelle réponse
    $sql = "UPDATE t_message SET reponse = :nouvelleReponse WHERE id = :message_id";
    $stmt = $con->prepare($sql);
    $stmt->bindParam(':nouvelleReponse', $nouvelleReponse);
...
<br><br>
   <table  border='0' width='98%'>
     ...
     <tr>
        ...
        <td class='btn-mod'><a href='repondre1.php?id=<?=$message_id; ?>'>Repondre</a></td> 
        <td class='btn-mod'><a href='modifiereponse1.php?id=<?=$message_id; ?>' onclick="return confirm('Modifier?');">Modifier</a></td>
        <td class='btn-sup'><a href='supprimermessage1.php?id=<?=$message_id; ?>' onclick="return confirm('supprimer?');">Supprimer</a></td> 
 </tr>
<?php 
 }
}
