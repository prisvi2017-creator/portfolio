<?php
 ...
 if ( isset($_POST["formation"]) && !empty($_POST["formation"])) {
   ...
   $sql = "INSERT INTO t_programme (id_enseignant, id_formation) VALUES (:id_enseignant, :id_formation)";
   ...
   if(!empty($_FILES['pdf']['name'])){
    ...
    if(!move_uploaded_file($_FILES['pdf']['tmp_name'],$dossierprog.$pdf))
        die("Impossible de copier le fichier dans le dossier");
    $update_pdf = $con->prepare("UPDATE t_programme SET pdf = :pdf WHERE id = :id");
    $update_pdf->bindParam(":id", $last_id);
    $update_pdf->bindParam(":pdf", $pdf);
    $update_pdf->execute();
}

$success_msg[] = 'Programme ajouté!';
}
  ?>
...
<div class="menu">
   ...
   <section class="video-form">
    <h1 class="heading">Ajouter un programme de cours</h1>

    <div class="box-container">
        <form action="" method="post"  enctype="multipart/form-data">
            <p>Programme en PDF <span>*</span></p>
           ...
           <p>Formation <span>*</span></p>
            ...
            <a href="voir_programmes.php" class="btn" >Voir les programmes</a>
