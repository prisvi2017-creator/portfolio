...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['mail_et']) && isset($_POST['mdp_et']) && !empty($_POST['mail_et']) && !empty($_POST['mdp_et'])) {
        ...
        if ($user) {
            ...
            if (password_verify($mdp_et, $user['mdp_et'])) {
                // Connexion réussie
                ...
                header("Location: connexion_etudiant.php?erreur=Mot de passe incorrect");
                exit();
            }
        } else {
            // Adresse email non valide
            header("Location: connexion_etudiant.php?erreur=Adresse email non valide");
            exit();
        }
    }
}
...
&copy; copyright @ 2025  <span>H<b style="color: #e81c11;">2</b>S<b style="color: #e81c11;">I</b></span> | tout droit reserves!
